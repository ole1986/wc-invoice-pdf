    ...
    public function BuildInvoice($invoice, $isOffer = false, $stream = false)
    {
        ...
        <table>
            <tr>
                ...
                <th style="text-align: right; width: 10%;"><?php _e('Qty', 'wc-invoice-pdf') ?></th>
                <th style="text-align: right; width: 20%;"><?php _e('Unit Price', 'wc-invoice-pdf') ?></th>
            ...
            foreach ($items as $v) {
                ...
                echo "<td>". $mdcontent . "<div style=\"text-align: right; font-size: small\">$product_name</div></td>";
