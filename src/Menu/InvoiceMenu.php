                ...
                <div id="wcinvoicepdf-invoice" class="inside tabs-panel" style="display: none;">
                    <div style="display: flex; flex-direction: row; flex-wrap: wrap">
                        <div class="wc-recurring-postbox postbox">
                            ...
                            $this->addField('wc_pdf_template', 'PDF Template', 'media', ['attr' => ['style' => 'padding-left: 0.5em']]);
                            if (empty(WcRecurringIndex::$OPTIONS['wc_pdf_template'])) {
                                echo "<span style='padding-left: 0.5em'>Get an example <a href='".WCRECURRING_PLUGIN_URL."/ressources/demo_invoice_template.docx' target='_blank'>here</a><span>";
                            }
